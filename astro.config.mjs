...
export default defineConfig({
  site: process.env.ASTRO_SITE ?? 'https://shubham.ch', // apex custom domain; override via ASTRO_SITE env var
  base: process.env.ASTRO_BASE ?? '', // empty base for apex domain (not a project subpath)
  output: 'static',
