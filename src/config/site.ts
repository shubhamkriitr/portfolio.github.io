...
export const site = {
  ...
  author: {
    ...
    email: 'shubhamkumar.iitr@gmail.com',
     ...
     * HTML is supported.
     */
    moreInfo: `<p>Zürich, Switzerland</p>`,
  },
  ...
  socials: {
    ...
    linkedin_username: 'shubhamkumar101',
    github_username: 'shubhamkriitr',
  ...
  footer: {
    ...
    text: `Built with
      ...
      theme. Hosted on <a href="https://pages.github.com/" target="_blank" rel="noopener noreferrer">GitHub Pages</a>.`,
  ...
  blog: {
    ...
    name: 'Blog',
    description: 'Notes on machine learning, computer vision, and things I build.',
  ...
  publications: {
     ...
     */
    authorLastName: 'Kumar' as string | undefined,
  ...
  pages: {
    projects: {
      ...
      description: 'Selected research and course projects in machine learning and computer vision.',
    },
    teaching: {
